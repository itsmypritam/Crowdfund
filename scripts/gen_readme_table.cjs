...
const lines = csv.map((r, i) => {
  ...
  return `| ${r.num} | ${r.name} | ${r.email} | [${short}](https://stellar.expert/explorer/testnet/account/${addr}) | [\`${txShort}\`](https://stellar.expert/explorer/testnet/tx/${txh}) | Donate | ${r.rating} |`;
});

const table = `#### 50-User Bulk Donation Tx Hashes
...
fs.writeFileSync("scripts/readme_table.md", table, "utf8");
console.log("Table written to scripts/readme_table.md");
